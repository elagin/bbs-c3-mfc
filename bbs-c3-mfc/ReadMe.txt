================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : bbs-c3-mfc Project Overview
===============================================================================

The application wizard has created this bbs-c3-mfc application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your bbs-c3-mfc application.
...
bbs-c3-mfc.h
    ...
    Cbbsc3mfcApp application class.
...
res\bbs-c3-mfc.ico
    ...
    icon is included by the main resource file bbs-c3-mfc.rc.
...
bbs-c3-mfcDlg.h, bbs-c3-mfcDlg.cpp - the dialog
    These files contain your Cbbsc3mfcDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in bbs-c3-mfc.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your Cbbsc3mfcDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named bbs-c3-mfc.pch and a precompiled types file named StdAfx.obj.
